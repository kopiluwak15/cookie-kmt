...
import { Save, Info, Send, Clock, AlertTriangle } from 'lucide-react'
...
const deliveryInfo = [
  {
    icon: Send,
    title: 'サンキューLINE',
    description: '施術ログ保存時に即時送信',
    color: 'text-green-600 bg-green-50',
  },
  {
    icon: Clock,
    title: 'リマインド①②',
    description: 'スタイル設定の日数後に自動送信（毎日10:00）',
    color: 'text-blue-600 bg-blue-50',
  },
  {
    icon: AlertTriangle,
    title: '休眠顧客LINE',
    description: 'しきい値超過の顧客に送信（毎週月曜10:00）',
    color: 'text-amber-600 bg-amber-50',
  },
  {
    icon: Send,
    title: 'メンテナンスチケット',
    description: 'コンセプトメニュー受診者に設定日数後送信（毎日11:00）',
    color: 'text-purple-600 bg-purple-50',
  },
]

export default function MarketingLinePage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold">LINE配信設定</h2>
        <p className="text-muted-foreground mt-1">顧客への自動LINE配信テンプレートとタイミングを設定します</p>
      </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {deliveryInfo.map((info) => (
              <div key={info.title} className="flex items-start gap-3 p-3 rounded-lg border">
          ...
          <p className="text-xs text-muted-foreground mt-3">
            ※ LINE連携済み かつ ブロックされていない顧客にのみ送信されます
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">配信タイミング設定</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label>予約URL</Label>
              <p className="text-xs text-muted-foreground">テンプレート内 {`{{booking_url}}`} に埋め込まれるURL</p>
              <div className="flex gap-2">
                ...
                <Button
                  size="sm"
                  onClick={() => {
                    const el = document.getElementById('ml_booking_url') as HTMLInputElement
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">この日数以上未来店の顧客に休眠LINEを送信</p>
              <div className="flex gap-2">
                <Input
                  type="number"
                  defaultValue={getSetting('dormant_threshold_days')}
                  id="ml_dormant_threshold"
                />
                <Button
                  size="sm"
                  onClick={() => {
                    const el = document.getElementById('ml_dormant_threshold') as HTMLInputElement
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">休眠顧客LINEの {`{{weekday_text}}`} に埋め込まれるテキスト</p>
            <div className="flex gap-2">
              <Input
              ...
              <Button
                size="sm"
                onClick={() => {
                  const el = document.getElementById('ml_weekday_text') as HTMLInputElement
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <div className="flex gap-2">
                ...
                <Button size="sm" onClick={() => {
                  const el = document.getElementById('ml_m1_days_after') as HTMLInputElement
            ...
            <div className="space-y-1">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button size="sm" onClick={() => {
                  const el = document.getElementById('ml_m1_validity') as HTMLInputElement
            ...
            <div className="space-y-1">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button size="sm" onClick={() => {
                  const el = document.getElementById('ml_m2_days_after') as HTMLInputElement
            ...
            <div className="space-y-1">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button size="sm" onClick={() => {
                  const el = document.getElementById('ml_m2_validity') as HTMLInputElement
      ...
      {/* テンプレート編集 */}
      <div>
        <h3 className="text-lg font-semibold mb-3">配信テンプレート</h3>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-muted-foreground">
                      利用可能な変数: {'{{customer_name}}'}, {'{{style_name}}'}, {'{{cycle_days}}'}, {'{{next_visit_date}}'}, {'{{coupon_text}}'}, {'{{weekday_text}}'}, {'{{booking_url}}'}
